/**
 * BFF: Email OTP verify – validate code, forward to auth-core, set cookie on success.
 */

import { emailOtpVerifySchema } from "~/schema/zod/authSchemas";
...
export default defineEventHandler(async (event) => {
  ...
  const path = getPath("auth", "email_otp", "verify");
